...
// amplify add api To create GraphQL API and Database
// amplify push --y to deploy API
...
// 4. amplify add storage to add storage
// 5. amplify push --y to deploy storage service and API Updates
